...
class InvitationManager(models.Manager):
    def invite(self, user, email,article):
        """
...
#            user.invitation_stats.use()
            ...
            invitation = self.create(user=user, email=email,
...
class Invitation(models.Model):
    ...
    article = models.ForeignKey(Article, related_name='author_invitations')
    ...
    def send_email(self, email=None, site=None, request=None, article = None):
        """
